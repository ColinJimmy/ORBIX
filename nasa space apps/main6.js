...
document.getElementById('check-answer').addEventListener('click', function() {
  ...
  if (selectedOption) {
      ...
      if (userAnswer === 'Deep Impact') {
          result.textContent = 'Correct!';
          result.style.fontSize = '25px';
          result.style.color = 'white';
          score6=5;
      } else {
          result.textContent = 'Sorry, that\'s incorrect. The correct answer is Deep Impact.';
          result.style.color = 'white';
          result.style.fontSize = '25px';
          score6=0;
      }
      document.getElementById('score').textContent = "Score = "+ score6;
  } else {
